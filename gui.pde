...
public void createGUI(){
  ...
  Android.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  budget.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  midrange.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  powerful.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  notch.setText("Notch");
  notch.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  hole.setText("Hole");
  hole.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  hole.setOpaque(true);
  ...
  bezelFree.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  bezel.setText("Bezel");
  bezel.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  small.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  regular.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  large.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  HUGE.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  HUGE.setOpaque(true);
  ...
  LCD.setText("LCD");
  LCD.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  LCD.setOpaque(true);
  ...
  p1440.setText("1440p+");
  p1440.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  GB256.setText("256");
  GB256.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  wantJack.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  ...
  wantExpandableMemory.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
