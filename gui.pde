...
public void createGUI() {
  ...
  resetButton = new GButton(this, 210, 520, 130, 20);
  ...
  label3 = new GLabel(this, 560, 230, 160, 50);
  ...
  label4 = new GLabel(this, 560, 340, 160, 20);
  label4.setText("Buy the phone from:");
  label4.setTextBold();
  label4.setOpaque(true);
  phoneSearch = new GTextField(this, 10, 520, 190, 20, G4P.SCROLLBARS_NONE);
